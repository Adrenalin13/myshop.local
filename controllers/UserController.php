...
function registerAction()
{
    ...
    if (!$resData) {
        ...
        if ($userData['success']) {
            $resData['message'] = 'Пользователь успешно зарегистриварон';
            $resData['success'] = 1;
 ...
 *
 * @return json обновление данных пользователя
 */
function updateAction()
{
    ...
    // проверка правильности пароля (введенный и тот, под которым зашли)
